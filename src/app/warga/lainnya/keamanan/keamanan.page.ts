...
export class KeamananPage implements OnInit {
  ...
  private calculateTotalProgress() {
    ...
    console.log('Security Progress (Keamanan Page):', {
  ...
  async openPhoneModal() {
    const modal = await this.modalController.create({
      ...
      cssClass: 'modern-phone-modal compact-modal',
  ...
  async openEmailModal() {
    const modal = await this.modalController.create({
      ...
      cssClass: 'modern-email-modal compact-modal',
      backdropDismiss: true,
      showBackdrop: true,
      animated: true,
      breakpoints: [0, 0.5, 0.8],
  ...
  async openPasswordModal() {
    const modal = await this.modalController.create({
      ...
      cssClass: 'modern-password-modal',
      backdropDismiss: true,
      showBackdrop: true,
      animated: true,
